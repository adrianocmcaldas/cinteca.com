...
export const translations: Record<Locale, SiteCopy> = {
  en: {
    ...
    status: ["Active company", "Technology activity since 2014", "Spain · Europe · International", "No cookies or tracking"],
    company: {
      label: "The company",
      ...
      activities: [
        { code: "SOFTWARE", title: "Products and platforms", description: "Web, mobile and desktop applications, APIs and integrations." },
        { code: "INTELLIGENCE", title: "Applied AI", description: "Assistants, models, automation and information processing." },
        { code: "INFRASTRUCTURE", title: "Systems and operations", description: "Cloud, local and hybrid environments, networks and accelerated computing." },
    ...
    products: {
      ...
      items: [
        { name: "LegalNeuron", code: "LEGAL AI", url: productUrls.legalNeuron, description: "Artificial intelligence and management software for legal professionals and law firms. It supports the analysis, review and automation of legal documents and processes." },
        { name: "NordixBIOS", code: "EMBEDDED AI", url: productUrls.nordixBios, description: "A white-label artificial intelligence assistant that integrates into existing software, performs operations and supports the product’s evolution." },
  ...
  es: {
    ...
    status: ["Empresa activa", "Actividad tecnológica desde 2014", "España · Europa · Internacional", "Sin cookies ni seguimiento"],
    company: {
      ...
      activities: [{ code: "SOFTWARE", title: "Productos y plataformas", description: "Aplicaciones web, móviles y de escritorio, APIs e integraciones." }, { code: "INTELIGENCIA", title: "IA aplicada", description: "Asistentes, modelos, automatización y procesamiento de información." }, { code: "INFRAESTRUCTURA", title: "Sistemas y operación", description: "Cloud, entornos locales e híbridos, redes y computación acelerada." }, { code: "INGENIERÍA", title: "Integración tecnológica", description: "Telecomunicaciones, automatización, electrónica y sistemas conectados." }],
    },
  ...
  pt: {
    ...
    company: {
      ...
      activities: [{ code: "SOFTWARE", title: "Produtos e plataformas", description: "Aplicações web, móveis e desktop, APIs e integrações." }, { code: "INTELIGÊNCIA", title: "IA aplicada", description: "Assistentes, modelos, automação e processamento de informação." }, { code: "INFRAESTRUTURA", title: "Sistemas e operação", description: "Cloud, ambientes locais e híbridos, redes e computação acelerada." }, { code: "ENGENHARIA", title: "Integração tecnológica", description: "Telecomunicações, automação, eletrônica e sistemas conectados." }],
    },
  ...
  nb: {
    ...
    company: {
      ...
      activities: [{ code: "PROGRAMVARE", title: "Produkter og plattformer", description: "Web-, mobil- og skrivebordsapplikasjoner, API-er og integrasjoner." }, { code: "INTELLIGENS", title: "Anvendt KI", description: "Assistenter, modeller, automatisering og informasjonsbehandling." }, { code: "INFRASTRUKTUR", title: "Systemer og drift", description: "Sky, lokale og hybride miljøer, nettverk og akselerert databehandling." }, { code: "INGENIØRFAG", title: "Teknologiintegrasjon", description: "Telekommunikasjon, automatisering, elektronikk og tilkoblede systemer." }],
    },
